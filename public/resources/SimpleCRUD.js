...
class SimpleCRUD{
    ...
    afterSave(obj, autoselect = true){
        ...
        if(!autoselect) this.element = undefined;
        this.row = undefined;
        this.isNew = undefined;
        const tableContainer = $(this.padre).find("[crud='table']").parent();
        const scrollTop = tableContainer.scrollTop();
        this.search(this._search.word); //vuelve a buscar la palabra para actualizar la tabla, esto es util para cuando se modifica un elemento y ya no coincide con la busqueda actual
